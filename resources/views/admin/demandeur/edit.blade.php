<x-admin-layout>
    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="flex m-2 p-2">
            <a href="{{ route('admin.demandeur.index') }}"
        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <form method="POST" action="{{ route('admin.demandeur.update', $demandeur->id) }}">
                    ...
                    <div>
                        ...
                        <input type="text" id="name" class="block mt-1 w-full" name="name"
                            value="{{ $demandeur->contact }}">

                    </div>

                    <div>
                        <x-label for="localite" :value="__('localite')" />
                        <input type="text" id="name" class="block mt-1 w-full" name="localite"
                            value="{{ $demandeur->localite }}">
