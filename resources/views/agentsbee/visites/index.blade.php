    ...
    <!-- Content Row -->
        <div class="card">
            <div class="card-header py-3 d-flex">
                ...
                <div class="ml-auto">
                    <a href="{{ route('agentsbee.visites.create') }}" class="btn btn-primary">
                        <span class="icon text-white-50">
                            <i class="fa fa-plus"></i>
                        </span>
                        <span class="text">{{ __('Nouvelle visite') }}</span>
                    </a>
                </div>
            </div>
            <div class="card-body">
                            ...
                            <tr data-entry-id="{{ $visite->id }}">
                                ...
                                <td>
                                    <div class="btn-group btn-group-sm">
                                        ...
                                        <form onclick="return confirm('are you sure ? ')" class="d-inline" action="{{ route('agentsbee.visites.destroy', $visite->id) }}" method="POST">
                                            @csrf
                                            @method('delete')
