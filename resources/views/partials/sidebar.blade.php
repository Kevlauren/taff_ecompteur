<ul class="navbar-nav bg-gradient-danger sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item {{ request()->is('agentsbee/demandeur') || request()->is('agentsbee/demandeur') ? 'active' : '' }}">
                <a class="nav-link" href="{{ route('agentsbee.demandeur.index') }}">
            ...
            <li class="nav-item {{ request()->is('agentsbee/calendrier') || request()->is('agentsbee/calendrier') ? 'active' : '' }}">
              ...
              ">
                ...
                {{-- {{ route('agentsbee.calendrier.index') }} --}}
                ">
                    <i class="fas fa-fw fa-calendar"></i>
